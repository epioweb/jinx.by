...
<script>
   new JCGetArItems(<?=CUtil::PhpToJSObject($arResult['ITEMS'], false, true); ?>);
</script>
<?
...
<div class="bx_size_scroller_container"><div class="bx_size">
   ...
   <select id="#ITEM#_prop_<? echo $arProp['ID']; ?>_list" style="width: <? echo '100% '/*$strWidth;*/ ?>;"><?
				 foreach ($arProp['VALUES'] as $arOneValue)
				{
					?>
 						...
 						style="<? echo $strOneWidth; ?>;"
					>
                                        <span>
                                        </span>
                                        <?=htmlspecialcharsex($arOneValue['NAME']); ?>
                                       </option>
<?
				}
?>
		...
		<div class="" id="#ITEM#_prop_<? echo $arProp['ID']; ?>_left" data-treevalue="<? echo $arProp['ID']; ?>" style="<? echo $strSlideStyle; ?>"></div>
		<div class="" id="#ITEM#_prop_<? echo $arProp['ID']; ?>_right" data-treevalue="<? echo $arProp['ID']; ?>" style="<? echo $strSlideStyle; ?>"></div>
	</div>
</div>
...
<?
			...
			elseif ('E' == $arProp['PROPERTY_TYPE'])
			{
				...
				?><div class="<? echo $strClass; ?>" id="#ITEM#_prop_<? echo $arProp['ID']; ?>_cont">
<span class="bx_item_section_name_gray"><? echo htmlspecialcharsex($arProp['NAME']); ?></span>
<div class="bx_scu_scroller_container"><div class="bx_scu"><ul id="#ITEM#_prop_<? echo $arProp['ID']; ?>_list" style="<? //echo $strWidth; ?>;"><?
				foreach ($arProp['VALUES'] as $arOneValue)
				{
					?><li
 						data-treevalue="<? echo $arProp['ID'].'_'.$arOneValue['ID'] ?>"
