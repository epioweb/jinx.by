...
?>
	<div class="<? echo $strClass; ?>" id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_cont">
		...
		<div class="bx_size_scroller_container"><div class="bx_size">
			<select id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_list" style="width: <? echo $strWidth; ?>;margin-left:0%;">
<?
...
?>
	...
	<div <?=("Y" != $arResult["SHOW_COLOR"]) ? 'style="display:none"' : ''?> class="<? echo $strClass; ?>" id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_cont">
		<span class="bx_item_section_name_gray"><? echo htmlspecialcharsex($arProp['NAME']); ?></span>
...
<!-- Buttons for changing PREMIUM/BASIC-->
<?if($arResult["PROPERTIES"]["BLINDING_TO_EL"]["VALUE"] != ''):?>
   <span>
<?if('PREMIUM' == $arResult["PROPERTIES"]["CATEGORY"]["VALUE"]):?>
      <a href="javascript:void()" style="cursor:default" class="bx_big bx_bt_white">
<?else: ?>
      <a href="<?=$arResult["PROPERTIES"]["BLINDING_TO_EL"]["DETAIL_PAGE_URL"]?>" class="bx_big bx_bt_blue">
<?endif?>
         <?=GetMessage('BUTTON_PREMIUM'); ?>
     </a>
   </span>

   <span>
<?if('BASIC' == $arResult["PROPERTIES"]["CATEGORY"]["VALUE"]):?>
      <a href="javascript:void()" style="cursor:default" class="bx_big bx_bt_white">
<?else: ?>
      <a href="<?=$arResult["PROPERTIES"]["BLINDING_TO_EL"]["DETAIL_PAGE_URL"]?>" class="bx_big bx_bt_blue">
<?endif?>
         <?=GetMessage('BUTTON_BASIC'); ?>
     </a>
   </span>
<?endif;?>
...
//$arResult["PROPERTIES"]["BLINDING_TO_EL"]["CATEGORY"]
?>
...
?>
	<div class="bx_item_description">
		<div class="bx_item_section_name_gray" style="border-bottom: 1px solid #f2f2f2;">
                   <? echo GetMessage('FULL_DESCRIPTION'); ?>
                </div>
<?
...
<!-- Для кроссбраузерности элементы с display:none удаляются -->
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
<script>
$(function () {
   $('.bx_size select option').each(function () {
