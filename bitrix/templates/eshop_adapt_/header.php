	...
	<div class="header_wrap">
		<div class="header_wrap_container">
			...
			<div class="header_inner" itemscope itemtype = "http://schema.org/LocalBusiness">
				<h1 class="site_title"><a href="<?=SITE_DIR?>" itemprop = "name"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/company_name.php"), false);?></a></h1>
