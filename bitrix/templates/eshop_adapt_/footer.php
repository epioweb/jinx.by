<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>			</div> <!-- //worakarea_wrap_container workarea-->
		</div> <!-- //workarea_wrap-->
...
"bitrix:main.include",
 ...
 "PATH" => SITE_DIR."include/Ymetrika_count.php"
), 
false);
?>
			...
			<div class="footer_wrap_container">
				...
				<div class="footer_container_tre">
					...
					*/
						...
						<ul>
						<?if ($facebookLink):?>
						<li class="fb"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
	...
	"ACTIVE_COMPONENT" => "Y"
						...
						<?endif?>
						<?if ($twitterLink):?>
						<li class="tw"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
	...
	"ACTIVE_COMPONENT" => "Y"
						...
						<?endif?>
						<?if ($googlePlusLink):?>
						<li class="gp"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
